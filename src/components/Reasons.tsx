...
const Reasons = () => {
  ...
  let isSmallMobile = useMediaQuery({ query: "(max-width: 540px)" }, undefined);
    ...
    <div>
      <div className="flex flex-wrap gap-5 xl:gap-8 justify-center w-full py-8">
        {(isMobile
          ...
          <div
            key={index}
            className="bg-[#94bdcbd4] w-full sm:w-[30rem] lg:w-[25rem] xl:w-[32rem] px-5 py-5 rounded-xl max-h-[30rem] drop-shadow-2xl text-md xl:text-lg"
          >
